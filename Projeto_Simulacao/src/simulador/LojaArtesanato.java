...
public class LojaArtesanato extends Sim_entity {
	...
	LojaArtesanato(String nome, double media, double variancia) {
	...
	public void body() {
		...
		while (Sim_system.running()) {
			...
			if (p <= 0.05) {
				//5% das pessoas vâo pra casa antes de ir pro evento
				sim_trace(1, "Pessoa vai pra casa");
				sim_schedule(saida, 0.0, 1);
				
			} else {
				//95% sai da loja e vai para o evento
